...
{
    return (m_health_pr == T->get_health_pr() && m_engine == T->get_engine() && m_square_type == T->get_square_type());
}
...
int Square::decrease_health(float dammage)
{
    ...
    else
    {
        ...
        if (m_square_type == SQUARE_TYPE::ENGINE_MOTOR || m_square_type == SQUARE_TYPE::ENGINE_MOTOR_DESACTIVATED ||
            m_square_type == SQUARE_TYPE::ENGINE_MOTOR_BURNED || m_square_type == SQUARE_TYPE::ENGINE_MOTOR_PERFORATED || m_square_type == SQUARE_TYPE::ENGINE_MOTOR_BURNED_PERFORATED || m_square_type == SQUARE_TYPE::ENGINE_MOTOR_DESACTIVATED_BURNED || m_square_type == SQUARE_TYPE::ENGINE_MOTOR_DESACTIVATED_PERFORATED || m_square_type == SQUARE_TYPE::ENGINE_MOTOR_DESACTIVATED_BURNED_PERFORATED)
        {
            m_engine->kill_motor();
            m_square_type = SQUARE_TYPE ::ENGINE_MOTOR_DEAD;
        }
        else if (m_square_type == SQUARE_TYPE::ENGINE_WEAPON || m_square_type == SQUARE_TYPE::ENGINE_WEAPON_DESACTIVATED || m_square_type == SQUARE_TYPE::ENGINE_WEAPON_BURNED || m_square_type == SQUARE_TYPE::ENGINE_WEAPON_PERFORATED || m_square_type == SQUARE_TYPE::ENGINE_WEAPON_BURNED_PERFORATED || m_square_type == SQUARE_TYPE::ENGINE_WEAPON_DESACTIVATED_BURNED || m_square_type == SQUARE_TYPE::ENGINE_WEAPON_DESACTIVATED_BURNED || m_square_type == SQUARE_TYPE::ENGINE_WEAPON_DESACTIVATED_PERFORATED || m_square_type == SQUARE_TYPE::ENGINE_WEAPON_DESACTIVATED_BURNED_PERFORATED)
        {
