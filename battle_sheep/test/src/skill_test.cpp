...
TEST_F(SkillTest, play_with_skills)
{
    ...
    ASSERT_EQ(engine16->Skill_shot(grid_1,grid_3,1,0,true,BOMBARDIER_SKILL),12);
    ASSERT_EQ(engine6->Skill_shot(grid_2,grid_4,1,0,true,BOMBARDIER_SKILL),12);
    ASSERT_EQ(engine13->Skill_shot(grid_1,3,5,true,CONTRE_TORPILLEUR_SKILL),2);
    ASSERT_EQ(engine3->Skill_shot(grid_2,3,5,true,CONTRE_TORPILLEUR_SKILL),2);
    ...
    ASSERT_EQ(engine16->Skill_shot(grid_2,grid_4,1,0,true,CONTRE_TORPILLEUR_SKILL),-1);
    ASSERT_EQ(engine13->Skill_shot(grid_2,3,5,true,CONTRE_TORPILLEUR_SKILL),-1);
